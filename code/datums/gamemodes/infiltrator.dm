...
#endif
	var/bigObjective = pick(list(pickedKidnap, pickedFortify, /datum/objective/specialist/infiltrator/makesilicon, /datum/objective/specialist/infiltrator/impersonateheads))
