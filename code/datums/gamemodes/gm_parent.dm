/datum/game_mode
	...
	var/shuttle_available_threshold = 3000 // 20 min. Only works when shuttle_available == 2.
	var/shuttle_auto_call_time = 18000 // 120 minutes.  Shuttle auto-called at this time and then again at this time + 1/2 this time, then every 1/2 this time after that. Set to 0 to disable.
